        ...
        <div className={styles.sidebar}>
          ...
          <div className={styles.Menu}>
            <ul className={styles.sidebar_list}>
              <NavLink  to="/" className = {styles.link}> <FaAngleRight/> <h2>Dashboard</h2></NavLink>
              <NavLink  to="/workspace" className = {styles.link}> <FaAngleRight/> <h2>Monitoramento</h2></NavLink>
            </ul>
          </div>

          <div className={styles.MenuFooter}>
            <ul className={styles.sidebar_list}>
              <NavLink  to="/workspace" className ={styles.link}> <FaAngleRight/> <h2>Configuração</h2></NavLink>
              <NavLink  to="/workspace" className ={styles.link}> <FaAngleRight/> <h2>Ajuda</h2></NavLink>
            </ul>
